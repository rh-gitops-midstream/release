...
UI dependencies can be prefetched with Hermeto `pnpm` from `pnpm-lock.yaml` once Konflux ships **Hermeto 0.57.0** (stable `pnpm` support, pending [build-definitions#3606](https://github.com/konflux-ci/build-definitions/pull/3606)).
