...
new_env = [
    ...
    {'name': 'RELATED_IMAGE_GITOPS_CONSOLE_PLUGIN_4_18_IMAGE', 'value': images['console-plugin-4-18']},
    {'name': 'GITOPS_CONSOLE_PLUGIN_4_18_IMAGE', 'value': images['console-plugin-4-18']},
