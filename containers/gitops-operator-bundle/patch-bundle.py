...
relatedImages = [
    ...
    {'name': 'gitops_console_plugin_image_pf5', 'image': images['console-plugin-4-18']},
...
new_env = [
    ...
    {'name': 'RELATED_IMAGE_GITOPS_CONSOLE_PLUGIN_IMAGE_PF5', 'value': images['console-plugin-4-18']},
    {'name': 'GITOPS_CONSOLE_PLUGIN_IMAGE_PF5', 'value': images['console-plugin-4-18']},
